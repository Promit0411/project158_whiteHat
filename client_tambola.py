    ...
    for row in range(0,3):
        ...
        for col in range(0,9):
            if(platform.system() == 'Darwin'):
                ...
                boxButton = tk.Button(gameWindow, font = ("Chalkboard SE", 30), 
                                      width = 3, 
                                      height = 2, 
                                      borderwidth = 5, 
                                      bg = "#fff176")
...
def gameWindow():
    ...
    flashNumberLabel = canvas2.crete_text(400, screen_height/2.3, text = "Wating for other players to join...", font = ("Chalkboard SE", 30), fill = "#3e2723")
